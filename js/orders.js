        ...
        if (data.data) {
            ...
            if (data.status === 200) {
                for (const i of data.data) {
                    ...
                    pId.dataset.order_id = i.order_idl
                    ...
                    const order_id = i.order_idl.toString().length === 1 ? '# 0000000' + i.order_idl : i.order_idl.toString().length === 2 ? '# 000000' + i.order_idl : i.order_idl.toString().length === 3 ? '# 00000' + i.order_idl : i.order_idl.toString().length === 4 ? '# 0000' + i.order_idl : i.order_idl.toString().length === 5 ? '# 000' + i.order_idl : i.order_idl.toString().length === 6 ? '# 00' + i.order_idl : i.order_idl.toString().length === 7 ? i.order_idl : i.order_idl
